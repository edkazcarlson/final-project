            ...
            <div className="App">
                ...
                <form>
                    ...
                    <label for="storyfirstword">Story first word </label><input id="storyfirstword"
                                                                                name="storyfirstword"
                                                                                className="storyInput"/><br/>
                    <label htmlFor="skip">Number of Contributions before Recontributing (should probably have a longer
                        explanation for this bit) </label><input id="skip" type="number" name="skip"
                                                                 className="storyInput"/><br/>
                    <input type="radio" id="word" name="storyType" value="word" checked/><label
                    htmlFor="word">Word</label><br/>
                    <input type="radio" id="phrase" name="storyType" value="phrase"/><label
                    htmlFor="phrase">Phrase</label><br/>
